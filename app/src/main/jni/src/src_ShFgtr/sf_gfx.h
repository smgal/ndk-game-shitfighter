...
#ifndef __SF_GFX_BOX_H__
#define __SF_GFX_BOX_H__
...
namespace gfx
{
	...
	void DrawText(int x, int y, const char* s, unsigned long real_color, bool use_fading);
...
namespace gfx_ix
{
	void DrawText(int x, int y, const char* s, TIndexColor color);
	void DrawText_x2(int x, int y, const char* s, TIndexColor color);
...
namespace gui
{
	...
	public:
		...
		void SetMessage(unsigned int line, const char* s);
	...
	public:
		...
		void SetLeftText(const char* sz_text);
		void SetRightText(const char* sz_text);
	...
	public:
		void Register(int x, int y, TIndexColor color, const char* sz_message);
		virtual void Show(void);
	};

}

#endif // #ifndef __SF_GFX_BOX_H__
